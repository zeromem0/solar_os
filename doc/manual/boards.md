...
| `ats_mini_v1` | `esp32-s3-devkitc1-n16r8` | ATS-Mini v1 | ESP32-S3 SI4732 receiver with a 170x320 ST7789 panel on an 8-bit i80 bus, radio I2C, SPI, battery ADC, and native USB CDC console. |
